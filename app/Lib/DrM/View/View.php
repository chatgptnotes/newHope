 ...
 */
	public function loadHelpers() {
		 ...
		 */ 
		$allowedHelpers = array_keys($this->request->autocompleteActionsHelper);
		$helpers = HelperCollection::normalizeObjectArray($this->helpers);
		foreach ($helpers as $name => $properties) {
			if($this->request->isAjax() && in_array($this->view, $allowedHelpers)){
				if(!in_array($name, $this->request->autocompleteActionsHelper[$this->view])) continue;
			}
