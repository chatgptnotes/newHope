var dataString ='<chart manageResize="1" scrollColor="99CCCC" scrollPadding="3" scrollHeight="20" scrollBtnWidth="28" scrollBtnPadding="3" dateFormat="dd/mm/yyyy" caption="Employee Schedule" subCaption="From 15th June 2011 - 21st June 2011" ganttPaneDuration="57" ganttPaneDurationUnit="d" palette="2">\n\
   <categories>\n\
   ...
   <processes fontSize="12" isBold="1" align="left" headerText="Who?" headerFontSize="18" headerVAlign="bottom" headerAlign="left">\n\
      <process label="King" id="EMP121"/>\n\
      <process label="Fuller" id="EMP122"/>\n\
      <process label="Peacock" id="EMP123"/>\n\
      <process label="Suyama" id="EMP124"/>\n\
      <process label="Callahan" id="EMP125"/>\n\
   </processes>\n\
   ...
   <tasks showLabels="1">\n\
      ...
      <task processId="EMP124" id="TSK1499" start="18/07/2007" end="22/07/2007" label="HTML5 Research"/>\n\
