...
<body>
	...
	<!--container starts-->
	<form id="sendForm" action="notepad.php" method="post">
		
	<div class="container" style="background-color:rgb(207, 206, 201);">
		<div class="row">
			...
			<div class="span7">
				...
				<div class="span7" style="margin: 0px;">
					...
					<h5>Choose Tools</h5>
					<div class="span6" data-toggle="buttons-radio" style="width:610px;margin: 0px;margin-bottom: 5px;">
						...
						<button class="btn btn-success btn-small"
							style="height: 28px; margin-top: 1px;" onclick="connect();"  type="button">
							<!-- <a href="#about"><i class="icon-pencil" title="pencil"></i></a> -->
							CONNECT

						</button>
						<button class="btn btn-success btn-small"
							style="height: 28px; margin-top: 1px;" onclick="online();" type="button">
						...
						<button class="btn btn-success btn-small"
							style="height: 28px; margin-top: 1px;"onclick="disconnect();" type="button">
						...
						<button class="btn btn-success btn-small"
							style="height: 28px; margin-top: 1px;"onclick="connTest();" type="button">
							<!-- <a href="#about"><i class="icon-download" title="new"></i></a> -->
							Conection Test
						</button>
...
/*
$image_source = "img/glyphicons_005_car.png";
