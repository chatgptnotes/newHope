...
<p class="ht5"></p>  
<form name="patientnotesfrm" id="patientnotesfrm" action="<?php echo $this->Html->url(array("controller" => "patients", "action" => "save_ot_post_operative_checklist", "admin" => false)); ?>" method="post" >
                      ...
                      <tr>
                        <td width="50%" align="left" valign="top" style="padding-top:7px;">
                          <table width="400" border="0" cellspacing="0" cellpadding="0" >
                              <tr>
                                <td width="100" height="25" valign="middle">Patient Name <font color="red">*</font> </td>
                                <td align="left" valign="top">
                                 <input type="text" name="data[PreOperativeChecklist][patient_name]" value="<?php echo $patientPOCheckListDetails['PreOperativeChecklist']['patient_name']; ?>" class="validate[required,custom[customname]] textBoxExpnd" id="patient_name" readonly='readonly' />
                                </td>
                                <td>
                                  <?php 
						   			echo $this->Html->link($this->Html->image('icons/patient-name.png',array('alt'=>__('UIDPatient Lookup'),'title'=>__('UIDPatient Lookup'))),'#',
						   				   array('escape' => false,'onclick'=>"var openWin = window.open('".$this->Html->url(array('controller'=>'opt_appointments','action'=>'patient_search','postchecklist'))."', '_blank',
                              ...
                              <tr>
                                <td height="25" valign="middle">Age (years)  </td>
                                <td align="left" valign="top">
                                 <input type="text" name="data[PreOperativeChecklist][age]" class="textBoxExpnd" id="age" value="<?php echo $patientPOCheckListDetails['PreOperativeChecklist']['age']; ?>" readonly/>
                                </td>
                              </tr>
                              <tr>
                                <td height="25" valign="middle">Sex </td>
                          		<td align="left" valign="top">
                                 
                               	  <select class="textBoxExpnd" name="data[PreOperativeChecklist][gender]" id="gender" readonly >
                                        <option value="">Please Select</option>
                                        <option value="M" <?php if($patientPOCheckListDetails['PreOperativeChecklist']['gender'] == "M") echo "selected"; ?> >Male</option>
                                        <option value="F" <?php if($patientPOCheckListDetails['PreOperativeChecklist']['gender'] == "F") echo "selected"; ?> >Female</option>
                                  </select>
                                </td>
                              </tr>
                       	  </table>
...
<table width="450" border="0" cellspacing="0" cellpadding="0" >
                                              <tr>
                                                <td width="160" height="35" valign="middle" class="tdLabel1" id="boxSpace1">Registration No. </td>
                                                <td align="left" valign="top"><input type="text" class="textBoxExpnd" name="data[PreOperativeChecklist][patient_uid]" id="registration_no" value="<?php echo $patientPOCheckListDetails['PreOperativeChecklist']['patient_uid']; ?>" readonly/></td>
</tr>
                                              <tr>
                                                <td height="35" valign="middle" class="tdLabel1" id="boxSpace1">Date of Birth </td>
                                                <td align="left" valign="top" style="padding:0;">
                                                <table width="230" border="0" cellspacing="0" cellpadding="0">
                                                  <tr>
                                                    <td width="140"><input type="text" class="textBoxExpnd" style="width:150px;" tabindex="16" name="data[PreOperativeChecklist][dob]" id="dob" value="<?php if($patientPOCheckListDetails['PreOperativeChecklist']['dob']) echo $this->DateFormat->formatDate2Local($patientPOCheckListDetails['PreOperativeChecklist']['dob'],Configure::read('date_format'));?>"  readonly /></td>
                                                    <td width="25" align="left" style="padding:0;"></td>
                                                  </tr>
                                                </table></td>
                                              </tr>
                                              <tr>
                                                <td height="35" valign="middle" class="tdLabel1" id="boxSpace1">&nbsp;</td>
 ...
 <?php echo __('Notes'); ?>
	...
	<?php 
			echo $this->Form->hidden('Note.id');
                        echo $this->Form->input('patient_uid', array('type' => 'hidden', 'id'=> 'patient_uid')); 
			   ...
			   <tr>
			    ...
			    <td>
			    	...
			    	<?php
			    		...
			    		echo $this->Form->input('sb_consultant', array('options'=>$consultant,'empty'=>'Please select','id' => 'sb_consultant','class'=>'validate[required,custom[mandatory-select]]', 'label'=> false)); 
			    	?>
			   ...
			   <tr>
			    ...
			    <td>
			    	<?php
			    		...
			    		echo $this->Form->input('sb_registrar', array('options'=>$registrar,'empty'=>'Please select','id' => 'sb_registrar','class'=>'validate[required,custom[mandatory-select]]' , 'label'=> false)); 
			    	?>
			    ...
			    <td>
			    	<?php
			    		...
			    		echo $this->Form->input('note_date', array('type'=>'text','id' => 'note_date','class'=>'validate[required,custom[mandatory-date]]' , 'label'=> false)); 
			    	?>
			   ...
			   <tr>
			    ...
			    <td>
			    	<?php 
			    		...
			    		echo $this->Form->input('note_type', array('empty'=>'Please select','options'=>$noteType, 'id' => 'note_type','class'=>'validate[required,custom[mandatory-select]]' , 'label'=> false)); 
			    	?>
								  ...
								  <td width="54%" align="center" valign="top">
			               		...
			               		<?php  
			               			...
			               			?>
						                  ...
						                  <td   align="left" valign="top">                  		                       		
						                       <?php echo $this->Form->input('', array('type'=>'text','class' => 'drugText' ,'id'=>"drug$i",'name'=> 'drug[]','value'=>$drugValue,'autocomplete'=>'off', 'label' => false)); ?>                        	 
						                  </td> 						                 
										  <td   align="left" valign="top">
						                  		<?php 
											$routes_options = array('IV'=>'IV','IM'=>'IM','S/C'=>'S/C','P.O'=>'P.O','P.R'=>'P.R','P/V'=>'P/V','R.T'=>'R.T');  
										  
										  echo $this->Form->input('', array( 'options'=>$routes_options,'empty'=>'Select','style'=>'width:80px','class' => '','id'=>"route$i",'name' => 'route[]','value'=>$routeValue , 'label' => false)); ?>
						                  </td>
						                  <td   align="left" valign="top">
						                  		<?php
											  	$fre_options = array('SOS'=>'SOS','OD'=>'OD','BD'=>'BD','TDS'=>'TDS','QID'=>'QID','HS'=>'HS');
										  		echo $this->Form->input('', array( 'options'=> $fre_options,'empty'=>'Select','style'=>'width:80px','class' => '','id'=>"frequency_$i",'class'=>'frequency','name' => 'frequency[]','value'=>$frequency, 'label' => false)); ?>
						                  </td>
						                  <td  align="left" valign="top">
						                  		<?php											  	
										  		echo $this->Form->input('', array('size'=>2,'type'=>'text','class' => '','id'=>"quantity$i",'name' => 'quantity[]','value'=>$quantity, 'label' => false)); ?>
						                  </td>
						                   <td   align="left" valign="top">
						                  		<?php echo $this->Form->input('', array( 'type'=>'text','class' => '','size'=>'2','id'=>"dose$i",'name' => 'dose[]','value'=>$doseValue, 'label' => false)); ?>
						                  </td>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
	   	  	<td >
	   	  		<div class="btns">
	   	  				 <?php  
	   	  				 	echo $this->Html->link(__('Cancel'), array('controller'=>'opt_appointments','action' => 'frontdesk_ot_appointment'), array('escape' => false,'class'=>'blueBtn'));	
		...
		var explode = admissionDate.split('-');
			...
			jQuery(document).ready(function(){
			    ...
			    $("#addButton").click(function () {		 				 
					...
					var route_option = '<select style="width:80px;" id="route'+counter+'" class="" name="route[]"><option value="">Select</option><option value="1">IV</option><option value="0">IM</option><option value="2">S/C</option><option value="3">P.O</option><option value="2">P.R</option><option value="3">P/V</option><option value="3">R.T</option></select>';
					var fre_option = '<select style="width:80px;" id="frequency_'+counter+'" class="frequency" name="frequency[]"><option value="">Select</option><option value="SOS">SOS</option><option value="OD">OD</option><option value="BD">BD</option><option value="TDS">TDS</option><option value="QID">QID</option><option value="HS">HS</option></select>';
					...
					var newHTml =    '<td><input  type="text" value="" id="drug' + counter + '" class=" drugText validate[optional,custom[onlyLetterNumber]] ac_input" name="drug[]" autocomplete="off"></td><td>'+route_option+'</td><td>'+fre_option+'</td>'+quality_opt+'<td><input size="2" type="text" value="" id="dose'+counter+'" class="" name="dose[]"></td>'+timer;
				...
				function ajaxPost(formname,updateId){ 
				        ...
				        $.ajax({
				            ...
				            type:"post", 
				            url:"<?php echo $this->Html->url((array('controller'=>'patients','action' => 'poc_notesadd')));?>"
				        }); 
				}
