...
<p class="ht5"></p>
                 <!-- two column table start here -->
                  ...
                  <?php 
				  		echo $this->Form->hidden('SurgicalSafetyChecklist.opt_appointment_id', array('id' => 'opt_appointment_id', 'label'=> false, 'div' => false, 'error' => false,'autocomplete'=>'off', 'style' => 'width:400px;', 'value'=> $optId));
