...
echo __('Edit Surgery Consent Form');
?></h3>
</div>
...
<form name="consentfrm" id="consentfrm"
	action="<?php echo $this->Html->url(array("controller" => "opt_appointments", "action" => "edit_surgery_consentform",$patient_id, $this->request->data['ConsentForm']['id'],$optId)); ?>"
	method="post">
	<?php 
	echo $this->Form->hidden('ConsentForm.opt_appointment_id', array('id' => 'opt_appointment_id', 'label'=> false, 'div' => false, 'error' => false,'autocomplete'=>'off', 'style' => 'width:400px;', 'value'=> $optId));

	echo $this->Form->input('ConsentForm.patient_id', array('type' => 'hidden', 'value'=> $patient_id, 'id' => 'patient_id'));
	echo $this->Form->input('ConsentForm.id', array('type' => 'hidden', 'id' => 'surgery_consent_id'));
	?>
	<table width="100%" cellpadding="0" cellspacing="0" border="0"
		class="tdLabel2">
		<tr>
			<td width="100"><?php echo __('Surgery'); ?>:</td>
			<td><?php echo $this->Form->input('ConsentForm.surgery_id', array('empty'=>__('Please Select'),'options'=>$surgeries, 'id' => 'surgery_id', 'label'=> false, 'style'=> 'width:300px;')); ?>
			</td>
		</tr>
		<tr>
			<td colspan="2">&nbsp;</td>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0"
		...
		<tr>
			...
			<td width="" align="left" valign="top" style="padding-bottom: 20px;">This
		...
		<tr>
			...
			<td width="" height="30" align="left" valign="top">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						<td style="padding: 10px 0 20px 0;">Upon your authorization and
		...
		<tr>
			...
			<td height="20" align="left" valign="top"
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td height="25" valign="top" style="padding-bottom: 10px;">By your
		...
		<tr>
			...
			<td height="20" align="left" valign="top"
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="300" valign="top">The practitioner who will perform
							your procedure is <font color="red">*</font>:
						</td>
					...
					<tr>
						<td colspan="2">You have the right to be informed of each
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0"
					...
					<tr>
						...
						<td>
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td><?php 
									echo $this->Form->input('ConsentForm.date_time', array('type'=> 'text','label'=> false, 'class' => 'textBoxExpnd','id' => 'date_time', 'style'=> 'width: 170px;', 'value' => $this->DateFormat->formatDate2Local($this->request->data['ConsentForm']['date_time'],Configure::read('date_format'), true)));
									?>
									</td>
		...
		<tr>
			<td height="25" align="left" valign="top">If signed by someone other
				than patient, indicate name relationship</td>
		</tr>
		<tr>
			<td><?php 
			echo $this->Form->input('ConsentForm.patient_relative', array('label'=> false,'class' => 'textBoxExpnd','id' => 'patient_relative'));
			?>
			</td>
		</tr>
		<tr>
			...
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						...
						<td><?php 
						echo $this->Form->input('ConsentForm.witness', array('label'=> false,'class' => 'textBoxExpnd','id' => 'witness'));
						?>
						</td>
					</tr>
				</table>
	...
	<p class="clr ht5"></p>
	<div class="btns">
		<?php echo $this->Html->link(__('Cancel', true),array('action' => 'surgery_consentform', $patient_id), array('escape' => false,'class'=>'grayBtn')); ?>
