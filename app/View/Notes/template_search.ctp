...
<tr>
   ...
   <td class="row_format leftPad10">
   		<?php 
   		 
   		 	echo $this->Js->link($doctortemp['NoteTemplate']['template_name'] , array('action' => 'add_template_text', $doctortemp['NoteTemplate']['id']), array('escape' => false,'update'=>"#$updateID",'method'=>'post','complete' => $this->Js->get('#busy-indicator')->effect('fadeOut', array('buffer' => false)),
...
<?php echo $this->Js->writeBuffer(); 	//please do not remove ?>