...
<?php  	
		echo $this->Html->css(array('internal_style','jquery.autocomplete','validationEngine.jquery.css'));
...
<?php } ?>		 
	<div id="docTemplate">
		<div class="inner_title">
			<h3><?php echo __('Doctor Templates', true); ?></h3>
			<span></span>
		</div>
		<?php echo $this->Form->create('DoctorTemplate',array('id'=>'doctortemplatefrm','default'=>false,'inputDefaults' => array('label' => false,'div' => false)));?>	
				<table border="0" class="table_format"  cellpadding="0" cellspacing="0" width="500px" >
						 <tr>
						  <td><label><?php echo __('Description');?>:</label></td>
						  <td>
						  		
						     		<?php echo $this->Form->textarea('description', array('class' => 'validate[required,custom[customdescription]]','id' => 'customdescription', 'label'=> false, 'div' => false,'error' => false ,'rows'=>'6','style'=>'width:500px')); ?>
