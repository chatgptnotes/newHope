...
<div class="inner_title">
	<h3><?php echo __('Edit Service Group'); ?></h3>
</div>
<?php echo $this->Form->create('ServiceCategory',array('type' => 'file','id'=>'ServiceCategory','inputDefaults' => array(
	...
	<td>
        <?php 
          echo $this->Form->input('ServiceSubCategory.unit', array('type' => 'radio','class' => '','label' => false,'legend' => false ,'options' => array('0'=>'APAM', '1' => 'KCHRC'), 'default' =>$error['ServiceSubCategory']['unit']));
        ?>
	</td>
	</tr>
	<tr>
