...
<table class="table_format" border="0" cellpadding="0" cellspacing="0"
	...
	<tr>
		...
		<td><?php echo $this->Form->input('ServiceCategory.name', array('id' => 'name', 'label'=> false, 'div' => false, 'error' => false,'readOnly'=>true));?>
		</td>
	</tr>
	<tr>
		<td align="right"><?php echo __('Alias'); ?><font color="red">*</font>
		</td>
		<td><?php 
		echo $this->Form->input('ServiceCategory.alias', array('class' => 'validate[required,custom[mandatory-enter-only]]', 'id' => 'alias', 'label'=> false, 'div' => false, 'error' => false,'onkeyup'=>'removeSpacesLeft(this.id);','onBlur'=>'removeSpacesRight(this.id);'));
		?>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td align="right"><?php echo __('Is Active'); ?>
		</td>
		<td><?php echo $this->Form->input('ServiceCategory.is_view', array( 'id' => 'is_view', 'label'=> false, 'div' => false, 'error' => false));?>
	   </td>
	</tr>
	<tr>
		<td align="right"><?php echo __('Is Enable For Nursing'); ?>
		</td>
		<td><?php echo $this->Form->input('ServiceCategory.is_enable_for_nursing', array('type'=>'checkbox', 'id' => 'is_enable_for_nursing', 'label'=> false, 'div' => false, 'error' => false));?>
		</td>
	</tr>
