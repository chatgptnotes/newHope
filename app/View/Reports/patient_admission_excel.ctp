...
<table border="1" class="table_format"  cellpadding="2" cellspacing="0" width="100%" style="text-align:left;padding-top:50px;">		
	      ...
	      if(count($reports) > 0) {
			...
			// if you select fields of finalbilling table //
			  ...
			  ?>
			   <tr> 
			   		<td height="30px" align="left" valign="bottom" align="center" colspan="<?php echo count($selctedFields)+14; ?>"><strong>Total Patients:<?php echo (count($reports)) ; ?></strong></td>											
							
						</tr>
				<?php 		  
				 } else {
					?> <tr>
									<td align="center" height="17px" colspan="15" > No Record Found</td>
