...
header ("Content-Disposition: attachment; filename=\"OT_Utilization_Rate". $this->DateFormat->formatDate2Local(date('Y-m-d H:i:s'),Configure::read('date_format'), true).".xls" );
...
<table border='1' class='table_format'  cellpadding='0' cellspacing='0' width='100%' style='text-align:left;padding-top:50px;'>		
     <tr class="row_title">
   <td colspan = "12" align="center"><h2>OT Utilization Rate</h2></td>
  </tr>
	  <tr class='row_title'>
		   ...
		   <td height='30px' align='center' valign='middle'><strong><?php echo __('OT Start Date & Time'); ?></strong></td>
		   <td height='30px' align='center' valign='middle'><strong><?php echo __('OT End Date & Time'); ?></strong></td>
		   <td height='30px' align='center' valign='middle'><strong><?php echo __('Total OT Time'); ?></strong></td>
...
?>
	...
	<td align='center' height='17px'><?php echo $i ?></td>
	   ...
	   <td align='center' height='17px'><?php echo $this->DateFormat->formatDate2Local($pdfData['OptAppointment']['endtime'],Configure::read('date_format'), true); $pdfData['OptAppointment']['end_time']; ?></td>
...
<?php $i++;  } ?>
	<tr>
		<td height="30px" align="center" valign="middle" colspan="12"><strong>OT Utilization Rate:<?php echo $totalUtilization; ?></strong></td>											
	</tr>
	<tr>
		<td height="30px" align="center" valign="middle" colspan="12" ><strong>Total Patients:<?php echo $i-1;?></strong></td>											
		
	 </tr>

<?php } else { ?>
		<tr>
			<td colspan = '8' align='center' height='30px'>No Record Found</td>
		</tr>
	 <?php } ?>
