...
<table width="1100" border="0" cellspacing="0" cellpadding="3" align="center" class="boxBorder" style="border-bottom:0px;">
  <tr>
   ...
   <td width="80" align="center" class="tblHead tdBorderRtBt"><?php echo __('Surgery Type') ?></td>
  ...
  ?>
   ...
   <td align="center" class="tdBorderRtBt"><?php echo $otdata['PatientInitial']['name']." ".$otdata['Patient']['lookup_name']; ?></td>
   ...
   <td align="center" class="tdBorderRtBt"><?php echo $otdata['Initial']['name'].' '.$otdata['DoctorProfile']['doctor_name']; ?></td>
