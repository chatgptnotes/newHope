	...
	<h3>&nbsp; <?php echo __('Consent Form', true); ?></h3>
	</div>
	<p class="ht5"></p>
	 <div class="btns">
  <?php #echo $this->Html->link(__('Print'), array('action' => 'printConsentForm',$consentData['Consent']['patient_id']), array('escape' => false,'class'=>'grayBtn'));
	echo $this->Html->link('Print','#',
			 array('class'=>'grayBtn', 'escape' => false,'onclick'=>"var openWin = window.open('".$this->Html->url(array('admin' => false, 'action'=>'printConsentForm',$consentData['Consent']['patient_id']))."', '_blank',
...
<?php echo $consentData['Consent']['patient_age']; ?>
                              ...
                              <tr>
                                ...
                                <td align="left">
<?php //echo $consentData['Consent']['patient_year']; ?>
</td>
                              </tr>
                              <tr>
...
<?php echo $consentData['Consent']['relative_age']; ?>
                          ...
                          <tr>
                            <td valign="middle" id="boxSpace" class="tdLabel"><?php //echo __('Years'); ?> </td>
                            <td align="left">
<?php //echo $consentData['Consent']['relative_year']; ?>
</td>
                          </tr>
...
<?php echo $consentData['Consent']['investigating_dr']; ?>
     ...
     <?php echo $consentData['Consent']['complications_arise']; ?> 
                          ...
                          <table width="100%" cellspacing="0" cellpadding="0" border="0">
                              <tbody><tr>
                                <td width="150">Dr. (Treating Doctor):&nbsp;</td>
                                <td>
<?php if(isset($doctors[$consentData['Consent']['surgeon_name']])) echo $doctors[$consentData['Consent']['surgeon_name']]; ?>
</td>
                              </tr>
                              <tr>
                                <td>Dr. (Anaesthetist):&nbsp;</td>
                                <td>
<?php if(isset($doctors[$consentData['Consent']['anaesthetic_name']])) echo $doctors[$consentData['Consent']['anaesthetic_name']]; ?>
</td>
                              </tr>
                            </tbody></table>
							<div class="ht5"></div>
...
<?php echo $consentData['Consent']['witness1_age']; ?>
                          ...
                          <tr>
                            <td valign="middle" id="boxSpace" class="tdLabel"><?php //echo __('Years'); ?> </td>
                            <td align="left">
<?php //echo $consentData['Consent']['witness1_year']; ?>
</td>
                          </tr>
                          <tr>
...
<?php echo $consentData['Consent']['witness2_age']; ?>
                          ...
                          <tr>
                            ...
                            <td align="left">
<?php //echo $consentData['Consent']['witness2_year']; ?>
</td>
                          </tr>
                          <tr>
