<div class="inner_title">
 <h3><?php echo __('Edit Insurance Type', true); ?></h3>
</div>
<script>
...
<?php } ?>
<form name="insurancetypefrm" id="insurancetypefrm" action="<?php echo $this->Html->url(array("action" => "edit")); ?>" method="post" onSubmit="return Validate(this);">
         
        <?php 
              echo $this->Form->input('InsuranceType.id', array('type' => 'hidden')); 
              echo $this->Form->input('InsuranceType.credit_type_id', array('type' => 'hidden', 'value' => 2)); 
        ?>
