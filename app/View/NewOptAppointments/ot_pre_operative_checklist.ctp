...
<div class="inner_title">
	...
	echo $this->Html->link(__('Add Pre Operative Checklist', true),array('action' => 'add_ot_pre_operative_checklist', $patient_id), array('escape' => false,'class'=>'blueBtn'));
...
<table border="0" class="table_format" cellpadding="0" cellspacing="0"
	...
	<tr <?php if($cnt%2 == 0) echo "class='row_gray'"; ?>>
		...
		echo $this->Html->link($this->Html->image('icons/print.png',array('title'=>'Print','alt'=>'Print')),'#',
											        ...
											        return false;"));
   ?> <?php
   echo $this->Html->link($this->Html->image('icons/edit-icon.png'),array('action' => 'add_ot_pre_operative_checklist',$patient_id, 'otpcid' => $pre_operative_checklist['PreOperativeChecklist']['id']), array('escape' => false,'title' => __('Edit', true), 'alt'=>__('Edit', true)));
   ?> <?php
   echo $this->Html->link($this->Html->image('icons/delete-icon.png'), array('action' => 'delete_ot_pre_operative_checklist', $patient_id, 'otpcid' => $pre_operative_checklist['PreOperativeChecklist']['id']), array('escape' => false,'title' => __('Delete', true), 'alt'=>__('Delete', true)),__('Are you sure?', true));
