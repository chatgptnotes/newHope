...
<title>OT Post Operative Check List</title>
<style>
	body{margin:0; padding:0; font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000000;}	
...
<table width="800" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
  	<td width="100%" align="center" style="padding-bottom:5px;">
         <?php echo $this->Html->image('/img/post-operative.gif', array('alt' => '')); ?>
    </td>
  </tr>
  <tr>
    <td width="100%" height="25" align="left" valign="top">
    	<table width="100%" border="0" cellspacing="0" cellpadding="4" class="boxBorder">
                      ...
                      <tr>
                        ...
                        <td width="48" class="tdBorderRtBt"><?php  if($patientPOCheckListDetails['PostOperativeChecklist']['sp_signed'] == 1) echo __('Yes'); else  echo __('No'); ?></td>
                      ...
                      <tr>
                        ...
                        <td width="48" class="tdBorderRtBt"><?php  if($patientPOCheckListDetails['PostOperativeChecklist']['hp_done'] == 1) echo __('Yes'); else  echo __('No'); ?></td>
          </tr>
                      <tr>
                        <td class="tdBorderBt">3.</td>
                        <td class="tdBorderRtBt">Consultation (if requested)</td>
                        <td width="48" class="tdBorderRtBt"><?php  if($patientPOCheckListDetails['PostOperativeChecklist']['consultation'] == 1) echo __('Yes'); else  echo __('No'); ?></td>
          </tr>
                      <tr>
                        <td class="tdBorderBt">4.</td>
                        <td class="tdBorderRtBt">Blood work done, result or chart</td>
                        <td width="48" class="tdBorderRtBt"><?php  if($patientPOCheckListDetails['PostOperativeChecklist']['bw_done'] == 1) echo __('Yes'); else  echo __('No'); ?></td>
          </tr>
                      <tr>
                        <td class="tdBorderBt">5.</td>
                        <td class="tdBorderRtBt">Urine analysis done, result or chart</td>
                        <td width="48" class="tdBorderRtBt"><?php  if($patientPOCheckListDetails['PostOperativeChecklist']['ua_done'] == 1) echo __('Yes'); else  echo __('No'); ?></td>
          </tr>
                      <tr>
                        <td class="tdBorderBt">6.</td>
                        <td class="tdBorderRtBt">Operative part are prepared</td>
                        <td width="48" class="tdBorderRtBt"><?php  if($patientPOCheckListDetails['PostOperativeChecklist']['op_prepare'] == 1) echo __('Yes'); else  echo __('No'); ?></td>
          </tr>
                      <tr>
                        <td class="tdBorderBt">7.</td>
                        <td class="tdBorderRtBt">Enema given, if ordered</td>
                        <td width="48" class="tdBorderRtBt"><?php  if($patientPOCheckListDetails['PostOperativeChecklist']['enema_given'] == 1) echo __('Yes'); else  echo __('No'); ?></td>
          </tr>
                     <tr>
                        <td class="tdBorderBt">8.</td>
                        <td class="tdBorderRtBt">N. P. O. notice at bedside</td>
                        <td width="48" class="tdBorderRtBt"><?php  echo $patientPOCheckListDetails['PostOperativeChecklist']['npo_notice_time']; ?></td>
          </tr>
                      ...
                      <tr>
                        ...
                        <td width="48" class="tdBorderRtBt"><?php  if($patientPOCheckListDetails['PostOperativeChecklist']['tc_done'] == 1) echo __('Yes'); else  echo __('No'); ?></td>
          </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td class="tdBorderRtBt"><?php  echo $patientPOCheckListDetails['PostOperativeChecklist']['npo_midnight']; ?></td>
                      </tr>
                      <tr>
                        ...
                        <td class="tdBorderRtBt"><?php  echo $patientPOCheckListDetails['PostOperativeChecklist']['identification_band']; ?></td>
                      </tr>
                      <tr>
                        <td valign="top" class="tdBorderBt">12.</td>
                        <td valign="top" class="tdBorderRtBt">Name plate with chart</td>
                        <td class="tdBorderRtBt"><?php  echo $patientPOCheckListDetails['PostOperativeChecklist']['name_plate']; ?></td>
                      </tr>
                      <tr>
                        <td valign="top" class="tdBorderBt">13.</td>
                        <td valign="top" class="tdBorderRtBt">Glasses / contact lenses removed</td>
                        <td width="48" class="tdBorderRtBt"><?php  if($patientPOCheckListDetails['PostOperativeChecklist']['glassess_removed'] == 1) echo __('Yes'); else  echo __('No'); ?></td>
          </tr>
                      <tr>
                        <td valign="top" class="tdBorderBt">14.</td>
                        <td valign="top" class="tdBorderRtBt">Dentures removed</td>
                        <td width="48" class="tdBorderRtBt"><?php  if($patientPOCheckListDetails['PostOperativeChecklist']['dentures_removed'] == 1) echo __('Yes'); else  echo __('No'); ?></td>
          </tr>
                      <tr>
                        <td valign="top" class="tdBorderBt">15.</td>
                        <td valign="top" class="tdBorderRtBt">Jewellery removed and secured</td>
                        <td width="48" class="tdBorderRtBt"><?php  if($patientPOCheckListDetails['PostOperativeChecklist']['jewellery_removed'] == 1) echo __('Yes'); else  echo __('No'); ?></td>
          </tr>
                      <tr>
                        <td valign="top" class="tdBorderBt">16.</td>
                        <td valign="top" class="tdBorderRtBt">Hairpins, makeup, nailpolish removed</td>
                        <td width="48" class="tdBorderRtBt"><?php  if($patientPOCheckListDetails['PostOperativeChecklist']['hairpins_removed'] == 1) echo __('Yes'); else  echo __('No'); ?></td>
          </tr>
                      <tr>
                        <td valign="top" class="tdBorderBt">17.</td>
                        <td valign="top" class="tdBorderRtBt">Head cap and hospital gown on</td>
                       <td width="48" class="tdBorderRtBt"><?php  if($patientPOCheckListDetails['PostOperativeChecklist']['headcap_hp_gown_on'] == 1) echo __('Yes'); else  echo __('No'); ?></td>
          </tr>
                      <tr>
                        <td valign="top" class="tdBorderBt">18.</td>
                        <td valign="top" class="tdBorderRtBt">Voided within an hour of surgery</td>
                        <td width="48" class="tdBorderRtBt"><?php  if($patientPOCheckListDetails['PostOperativeChecklist']['voided_surgery'] == 1) echo __('Yes'); else  echo __('No'); ?></td>
          </tr>
                      <tr>
                        <td valign="top" class="tdBorderBt">19.</td>
                        <td valign="top" class="tdBorderRtBt">Cathetrised Time</td>
                        <td width="48" class="tdBorderRtBt"><?php  echo $patientPOCheckListDetails['PostOperativeChecklist']['cathertrised_time']; ?></td>
          </tr>
                    ...
                    <td width="61" valign="bottom" class="tdBorderBt"><?php  echo $patientPOCheckListDetails['PostOperativeChecklist']['temp']; ?></td>
                                  <td width="19" valign="bottom">&nbsp;</td>
                                  <td width="57" valign="bottom">Pulse:</td>
                    <td width="60" valign="bottom" class="tdBorderBt"><?php  echo $patientPOCheckListDetails['PostOperativeChecklist']['pulse']; ?></td>
                    <td width="19" valign="bottom">&nbsp;</td>
                                  <td width="47" valign="bottom">Resp. :</td>
                                  <td width="66" valign="bottom" class="tdBorderBt"><?php  echo $patientPOCheckListDetails['PostOperativeChecklist']['resp']; ?></td>
                                  <td width="4">&nbsp;</td>
                              </tr>
                            	<tr>
                            	  <td height="20" valign="bottom">B.P. :</td>
                            	  <td valign="bottom" class="tdBorderBt"><?php  echo $patientPOCheckListDetails['PostOperativeChecklist']['blood_pressure']; ?></td>
                            	  <td valign="bottom">&nbsp;</td>
                            	  <td valign="bottom">Weight :</td>
                            	  <td valign="bottom" class="tdBorderBt"><?php  echo $patientPOCheckListDetails['PostOperativeChecklist']['weight']; ?></td>
                            	  <td valign="bottom">&nbsp;</td>
                            	  <td valign="bottom">&nbsp;</td>
                            	  <td valign="bottom">&nbsp;</td>
                            	  <td>&nbsp;</td>
                            	...
                            	<tr>
                            	  <td height="30" colspan="9" valign="bottom"><strong>POST-OPERATIVE MEDICATION ORDER</strong></td>
                           	  </tr>
                            </table>                         </td>
                        <td class="tdBorderRtBt">&nbsp;</td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                          ...
                          <tr>
                            ...
                            <td valign="bottom" class="tdBorderBt"><?php  echo $patientPOCheckListDetails['PostOperativeChecklist']['pre_given']; ?></td>
                            <td valign="bottom">&nbsp;</td>
                            <td valign="bottom">PM Date :</td>
                            <td valign="bottom" class="tdBorderBt"><?php
								echo $this->DateFormat->formatDate2Local($patientPOCheckListDetails['PostOperativeChecklist']['pre_date'],Configure::read('date_format'));
                            ?></td>
                          </tr>
                          <tr>
