...
<div class="inner_title">
	<h3>
		<?php echo __('Add Post Operative Notes'); ?>
	</h3>
	<span>
	<?php 
...
<p class="ht5"></p>
<form name="patientnotesfrm"
	id="patientnotesfrm"
	action="<?php echo $this->Html->url(array("action" => "save_ot_post_operative_checklist", "admin" => false)); ?>"
	method="post">
	...
	<table class="table_format" id="schedule_form">
		<tr>
			...
			echo $this->Form->input('Note.surgery_id', array('options'=>$surgeries,'empty'=>'Please select','id' => 'surgery','class'=>'validate[required,custom[mandatory-select]]', 'label'=> false,'style'=> 'width:200px'));
			?></td>
		</tr>
		<tr>
			<td><font color="red">*</font><?php echo __(' S/B Registrar ');?>:
			</td>
			<td><?php
		...
		<tr>
			<td><font color="red">*</font><?php echo __(' S/B  Consultant ');?>:
			</td>
			<td><?php
		...
		<tr>
			<td><font color="red">*</font><?php echo __(' Date ');?>:
			</td>
			<td><?php
	...
	<div id="accordionCust">
		<h4 style="display: block" id="post-opt-link">
			<a href="#" style="text-decoration: none; cursor: auto;">Post
				Operative Note<font color="red">*</font>
			</a>
		</h4>
				...
				<tr>
					...
					<td width="70%" align="left" valign="top">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="20">&nbsp;</td>
								<td valign="top" colspan="4"><?php echo $this->Form->textarea('Note.post_opt', array('id' => 'post-opt_desc','rows'=>'21','style'=>'width:90%', 'class'=>'validate[required,custom[customnotes]]')); ?>
								</td>
							</tr>
						</table>
					</td>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td >
				<div class="btns" style="padding-right: 90px" >
					<?php  
					//echo $this->Html->link(__('Cancel'), array('action' => 'ot_post_operative_checklist', $patient_id), array('escape' => false,'class'=>'grayBtn'));
