...
<h3><?php echo __('Consultant Schedule::Assign Consultant Appointment', true); ?></h3>
</div>
<table border="0" class="table_format" cellpadding="0" cellspacing="0" width="80%"  align="center" >
	 ...
	 <td class="form_lables">
          <?php 
                ...
                $attributes = array('id'=> 'monthval', 'value' => date('m'), 'onchange'=> $this->Js->request(array('action' => 'consultant_schedule'),array('before' => $this->Js->get('#busy-indicator')->effect('fadeIn', array('buffer' => false)),
    'complete' => $this->Js->get('#busy-indicator')->effect('fadeOut', array('buffer' => false)),'async' => true, 'update' => '#appointment', 'data' => '{monthidval:$("#monthval").val(),yearidval:$("#yearval").val(),consultantidval:$("#consultantid").val()}', 'dataExpression' => true)));
         ...
         <?php 
          $options = array('2011' => '2011', '2012' => '2012', '2013' => '2013', '2014' => '2014', '2015' => '2015', '2016' => '2016', '2017' => '2017','2018' => '2018', '2019' => '2019', '2020' => '2020' , '2021' => '2021', '2022' => '2022','2023' => '2023','2024' => '2024','2025' => '2025','2026' => '2026','2027' => '2027','2028' => '2028','2029' => '2029','2030' => '2030');
                 $attributes = array('id'=> 'yearval', 'value' => date('Y'), 'onchange'=> $this->Js->request(array('action' => 'consultant_schedule'),array('before' => $this->Js->get('#busy-indicator')->effect('fadeIn', array('buffer' => false)),
    'complete' => $this->Js->get('#busy-indicator')->effect('fadeOut', array('buffer' => false)),'async' => true, 'update' => '#appointment', 'data' => '{monthidval:$("#monthval").val(),yearidval:$("#yearval").val(),consultantidval:$("#consultantid").val()}', 'dataExpression' => true)));
...
$(document).ready(function(){
		// binds form submission and fields to the validation engine
	        jQuery("#consultantschedulesfrm").validationEngine();
