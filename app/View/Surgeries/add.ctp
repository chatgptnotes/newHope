...
<form name="surgeryfrm" id="surgeryfrm"
    ...
    'complete' => $this->Js->get('#busy-indicator')->effect('fadeOut', array('buffer' => false)), 'async' => true, 'update' => '#changesubcategory', 'data' => '{surgery_category:$("#surgery_category_id").val()}', 'dataExpression' => true))));
	   ?>
		...
		<tr>
			...
			echo $this->Form->input('Surgery.surgery_subcategory_id', array('id' => 'surgery_subcategory_id', 'empty' => 'Select Surgery Subcategory', 'label'=> false, 'div' => false, 'error' => false));
			?>
			</td>
		</tr>
		...
		<tr>
			<td colspan="2"><?php //echo __('Surgery Charges:'); ?></td>
		</tr>
		<tr>
			<td style="padding-left: 15px;"><?php // echo __('Service Group',true); ?>
			</td>
			<td><?php
    ...
    'complete' => $this->Js->get('#busy-indicator')->effect('fadeOut', array('buffer' => false)), 'async' => true, 'update' => '#changeservices', 'data' => '{service_group:$("#service_group").val()}', 'dataExpression' => true))));*/
		...
		<tr>
			<td class="form_lables" style="padding-left: 15px;"><?php //echo __('Service',true); ?>
			</td>
			<td id="changeservices"><?php
			//echo $this->Form->input('Surgery.tariff_list_id', array('style' => 'width:450px;','class' => 'validate[required,custom[mandatory-select]]','id' => 'tariff_list_id', 'label'=> false, 'div' => false, 'error' => false,'empty' => 'Select Service'));
			?>
			</td>
		</tr>
		<tr>
