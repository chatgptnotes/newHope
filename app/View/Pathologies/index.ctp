...
<div class="inner_title">
	<h3><img src="images/appointment_icon.png" /> &nbsp; <?php echo __('Patient Management', true); ?></h3>
	<span></span>
</div>
<?php echo $this->Form->create('Pathology',array('action'=>'index','type'=>'get'));?>	
				      		...
				      		foreach($data as $patients){
								  ...
								  ?>								  
								   ...
								   <td class="row_format"><?php 
								   		echo $this->DateFormat->formatDate2Local($patients['Patient']['create_time'],Configure::read('date_format'));
								   ?> </td>	   
								   <td ><?php 
								   		echo $this->Html->link($this->Html->image('icons/view-icon.png'), array('action' => 'requestTest', $patients['Patient']['id']), array('escape' => false));
								   ?>
								  </td>
								  </tr>
					  <?php } 
