...
<div class="inner_title">
	<h3><?php echo __('Add State', true); ?></h3>
</div>
<?php 
  if(!empty($errors)) {
?>
...
<form name="statefrm" id="statefrm" action="<?php echo $this->Html->url(array("controller" => $this->params['controller'], "action" => "add", "admin" => true)); ?>" method="post" >
