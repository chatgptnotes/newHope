...
<?php 
echo $this->Html->link(__('Back'),array('action' => 'estimateTypes',$patientData['EstimatePatient']['id']), array('escape' => false,'class'=>'blueBtn','id'=>'back','style'=>'margin-left:0px;'));
echo $this->Html->link('Print','#',
			 array('class'=>'grayBtn', 'escape' => false,'onclick'=>"var openWin = window.open('".html_entity_decode($this->Html->url(array('admin' => false, 'action'=>'printEstimateInvoice',$patientData['EstimatePatient']['id']),true))."', '_blank',
