         ...
         $dialogContent.dialog({
            ...
            buttons: {
               Save : function() {
                  ...
                  $('#busy-indicator').show();
                  var data = 'scheduledate=' + scheduledate +'&starttime=' + schedule_starttime + '&endtime=' + schedule_endtime  + '&purpose=' + purposefield;
                  $.ajax({url: "<?php echo $this->Html->url(array("controller" => "staff_plans", "action" => "saveStaffOwnEvent", "admin" => false)); ?>",type: "GET",data: data,success: function (html) { $('#busy-indicator').hide(); window.location = "<?php echo $this->Html->url(array("controller" => "staff_plans", "action" => "staff_ownevent", $showCalendarDay));?>";  } });
                  $('#busy-indicator').show();
                  $calendar.weekCalendar("removeUnsavedEvents");
         ...
         $dialogContent.dialog({
            ...
            buttons: {
               Save : function() {
                  ...
                  $('#busy-indicator').show();
                  var data = 'id=' + calEvent.id +'&scheduledate=' + scheduledate +'&starttime=' + schedule_starttime + '&endtime=' + schedule_endtime + '&purpose=' + purposefield;
                  $.ajax({url: "<?php echo $this->Html->url(array("controller" => "staff_plans", "action" => "updateStaffEvent", "admin" => false)); ?>",type: "GET",data: data,success: function (html) {  $('#busy-indicator').hide(); window.location = "<?php echo $this->Html->url(array("controller" => "staff_plans", "action" => "staff_ownevent",  $showCalendarDay));?>"; } });
                  $calendar.weekCalendar("updateEvent", calEvent);
                  $dialogContent.dialog("close");
               },
               "Delete" : function() {
                  ...
                  $('#busy-indicator').show();
                  $.ajax({url: "<?php echo $this->Html->url(array("controller" => "staff_plans", "action" => "deleteStaffEvent", "admin" => false)); ?>",type: "GET",data: data,success: function (html) {$('#busy-indicator').hide(); window.location = "<?php echo $this->Html->url(array("controller" => "staff_plans", "action" => "staff_ownevent", $showCalendarDay));?>";} });
...
<div style="text-align:center;margin-top:10px;">
 <?php 
    echo $this->Html->link(__('Daily Plan'), array('action' => 'staff_ownevent', 1), array('escape' => false,'class'=>'blueBtn'));
 ?>&nbsp;&nbsp;
 <?php 
    echo $this->Html->link(__('Weekly Plan'), array('action' => 'staff_ownevent', 7), array('escape' => false,'class'=>'blueBtn'));
 ?>
</div>
