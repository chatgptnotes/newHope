<div class="inner_title">
 <h3><?php echo __('Add Corporate Location', true); ?></h3>
</div>
<script>
...
<?php } ?>
<form name="corporatelocationfrm" id="corporatelocationfrm" action="<?php echo $this->Html->url(array("action" => "add")); ?>" method="post" onSubmit="return Validate(this);" >
<?php echo $this->Form->input('CorporateLocation.credit_type_id', array('type' => 'hidden', 'value' => 1)); ?>
	<table border="0" class="table_format" cellpadding="0" cellspacing="0" width="60%"  align="center">
	  ...
	  <td>
	   <?php 
	          echo $this->Form->input('CorporateLocation.name', array('class' => 'validate[required,custom[name]]','id' => 'corporatename', 'label'=> false, 'div' => false, 'error' => false));
	   ?>
	  </td>
	 </tr>
 	 <tr>
