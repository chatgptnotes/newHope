<div class="inner_title">
 <h3><?php echo __('Add Referer Doctor', true); ?></h3>
</div>
<script>
...
<?php } ?>
<form name="reffererdoctorfrm" id="reffererdoctorfrm" action="<?php echo $this->Html->url(array("action" => "add")); ?>" method="post" onSubmit="return Validate(this);" >
