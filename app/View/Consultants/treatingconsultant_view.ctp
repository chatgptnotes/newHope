...
<h3>
<div style="float:left"> <?php  echo Configure::read('doctor'); ?></div>			
...
<table border="0" cellpadding="0" cellspacing="0" align="center" class="table_view_format"> 
 ...
 <tr>
  ...
  <td>
   <?php // echo $doctor['Doctor']['licensure_type']; ?>
    <?php echo $licenture[LicensureType][name]?>
  </td>
 </tr>
 ...
 <tr>
  ...
  <td>
   <?php echo $doctor['Doctor']['licensure_no']; ?>
  </td>
 </tr>
 ...
 <tr>
  ...
  <tr class="row_gray">
  <td class="row_format">
   <strong><?php echo __('Specilty',true); ?></strong>
  </td>
  <td>
  ...
  <tr class="row_gray">
  <td class="row_format">
   <strong><?php echo __('Has Speciality',true); ?></strong>
  </td>
  <td>
   <?php 
  ...
  <tr>
  <td class="row_format">
   <strong><?php echo __('Speciality Keyword',true); ?></strong>
  </td>
  <td>
