...
<div class="vlr">&nbsp;</div>
<form name="consultantsearchfrm" id="consultantsearchfrm" action="<?php echo $this->Html->url(array("action" => "index")); ?>" method="post" >
<table border="0" class="table_format"  cellpadding="3" cellspacing="0" width="100%" align="center">
  <tr class="row_title">				 
   ...
   <td class=" ">
    <?php 
        echo $this->Form->input('first_name_search', array('id' => 'first_name_search', 'label'=> false, 'div' => false, 'error' => false, 'type'=> 'text','autocomplete'=>false));
    ?>
   </td>
<td class=" " align="left" width="12%"><?php echo __('Last Name') ?> :</td>								
   <td class=" ">
    <?php 
        echo $this->Form->input('last_name_search', array( 'id' => 'last_name_search', 'label'=> false, 'div' => false, 'error' => false, 'type'=> 'text','autocomplete'=>false));
...
<table border="0" class="table_format" cellpadding="0" cellspacing="0" width="100%">
   ...
   <td class="table_cell"><strong><?php echo __('First Name', true); ?></strong></td>
    <!--<td class="table_cell"><strong><?php echo __('Agent ID', true); ?></strong></td>-->
  ...
  ?>
   ...
   <td>
   <?php 
   		echo $this->Html->link($this->Html->image('icons/view-icon.png'), array('action' => 'view', $consultant['Consultant']['id'], 'admin'=> false), array('escape' => false,'title' => 'View', 'alt'=>'View'));
   ?>
...
<script>
  $(document).ready(function(){
			...
			$("#first_name_search").autocomplete("<?php echo $this->Html->url(array("controller" => "consultants", "action" => "autocompelete_consultant", "first_name", "admin" => false,"plugin"=>false, 'superadmin' => false)); ?>", {
				width: 250,
				selectFirst: true
			});
			$("#last_name_search").autocomplete("<?php echo $this->Html->url(array("controller" => "consultants", "action" => "autocompelete_consultant", "last_name", "admin" => false,"plugin"=>false, 'superadmin' => false)); ?>", {
				width: 250,
				selectFirst: true
			});
