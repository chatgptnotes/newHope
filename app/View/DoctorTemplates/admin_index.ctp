...
?>
	...
	<div id="docTemplate">
		<div class="inner_title">
			<h3>
				<?php echo __('Doctor Template', true); ?>
			</h3>
			<span> <?php
		...
		<?php 	echo $this->Form->create('DoctorTemplate',array('action'=>'admin_template_add','id'=>'doctortemplatefrm', 'inputDefaults' => array('label' => false,'div' => false)));
		...
		<table border="0" class="table_format" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				$templateType= array('complaints'=>'Presenting Complaints','lab-reports'=>'Lab Reports','examine'=>'Examination','diagnosis'=>'Diagnosis','surgery'=>'Surgery','care_plan'=>'Care Plan','histo_pathology'=>'Histo Pathology' );
						     				...
						     				echo $this->Form->input('template_type', array('options'=>$templateType,'empty'=>__('Please select'),'class' => 'validate[required,custom[mandatory-select]] textBoxExpnd','id' => 'template_type')); ?>
				</td>
			</tr>
                         <?php if($this->request->data['DoctorTemplate']['template_type'] == 'histo_pathology'){
                                    $hisDisplay = "inline";$genDisplay = "none";
                                }else{
                                    $genDisplay = "inline";$hisDisplay = "none";
                                }
                                    
                            ?>
                        <tr id="generalSpeciality" style="display:<?php echo $genDisplay;?>">

				<td><label><?php echo __("Specialty");?>:<font
				color="red">*</font></label>

				</td>
				<td><?php echo $this->Form->input('department_id', array('style'=>'width:300px','empty'=>__('Please Select'),'options'=>$departments,'style'=>'','class' => 'validate[required,custom[mandatory-select]] textBoxExpnd','id' => 'department_id','label'=> false)); ?>
				</td>
				
			</tr>
                         
                        
                        <tr class="histoTemplateSubCategories" style="display:<?php echo $hisDisplay;?>">
					<td><label><?php echo __('Histo Category');?>:<font
				color="red">*</font></label>
				</td>
				<td><?php echo $this->Form->input('department_id', array('style'=>'width:300px','empty'=>'Please Select','options'=>$histoCategoriesData,'type'=>'select','class' => 'validate[required,custom[mandatory-enter]] textBoxExpnd')); ?>
				</td>
			</tr>
			...
			<tr>
				...
				<td><?php echo $this->Form->input('template_name', array('style'=>'width:300px','type'=>'text','class' => 'validate[required,custom[mandatory-enter]] textBoxExpnd','id' => 'customdescription')); ?>
				</td>
			</tr>
		...
		<table border="0" class="table_format" cellpadding="0" cellspacing="0"
		    ...
		    -->
				...
				<td><?php
				echo $this->Html->link($this->Html->image('icons/view-icon.png', array('title'=> __('Doctor Template View', true),
		   			 					'alt'=> __('View Template Text', true))), array('action' => 'admin_template_index', $doctortemp['DoctorTemplate']['id']), array('escape' => false ));
		   			echo $this->Html->link($this->Html->image('icons/edit-icon.png', array('title'=> __('Doctor Template Edit', true),
		   			 					'alt'=> __('Edit', true))), array('action' => 'index', $doctortemp['DoctorTemplate']['id']), array('escape' => false ));
		   			echo $this->Html->link($this->Html->image('icons/delete-icon.png', array('title'=> __('Doctor Template Delete', true),
		   			 					'alt'=> __('Delete', true))), array('action' => 'admin_template_delete', $doctortemp['DoctorTemplate']['id']), array('escape' => false ),"Are you sure you wish to delete this template?");
