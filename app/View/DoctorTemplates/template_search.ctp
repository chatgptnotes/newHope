							  ...
							  ?>
								   ...
								   <td class="row_format leftPad10" style="font-size:11px;">
								   		<?php 
								   		 	...
								   		 	echo $this->Js->link($doctortemp['DoctorTemplate']['template_name'] , array('action' => 'add_template_text', $doctortemp['DoctorTemplate']['id']), array('escape' => false,'update'=>"#$updateID",'method'=>'post','complete' => $this->Js->get('#busy-indicator')->effect('fadeOut', array('buffer' => false)),
