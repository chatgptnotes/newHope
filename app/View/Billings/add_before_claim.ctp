								...
								<td>
									<table cellpadding="0" cellspacing="0" width="100%"
										...
										<tr>
											...
											<td width="11%"><?php 
											echo $this->Form->input('TariffStandard.cpt_codes', array('class' => '', 'id' => 'cpt_codes','empty'=>__('Select'),'options'=>'', 'label'=> false, 'div' => false, 'error' => false,'style'=>'width:85px;','placeholder'=>''));
											?> <?php
											echo $this->Form->input('TariffStandard.cpt_codes', array('class' => '', 'id' => 'cpt_codes','empty'=>__('Select'),'options'=>'', 'label'=> false, 'div' => false, 'error' => false,'style'=>'width:85px;','placeholder'=>''));
											?> <?php
											echo $this->Form->input('TariffStandard.cpt_codes', array('class' => '', 'id' => 'cpt_codes','empty'=>__('Select'),'options'=>'', 'label'=> false, 'div' => false, 'error' => false,'style'=>'width:85px;','placeholder'=>''));
										...
										<tr>
											...
											<td width="11%"><?php 
											echo $this->Form->input('TariffStandard.cpt_codes', array('class' => '','type'=>'text', 'id' => 'cpt_codes', 'label'=> false, 'div' => false, 'error' => false,'style'=>'width:334px;','placeholder'=>''));
											?>
											</td>
										</tr>
										<tr>
