...
<?php echo $this->Form->create('DischargeTemplate',array('action'=>'edit','id'=>'DischargeTemplatefrm','default'=>false,'inputDefaults' => array('label' => false,'div' => false)));?>	
<table border="0" class="table_format"  cellpadding="0" cellspacing="0" width="500px" >
 ...
 <table border="0" class="table_format" cellpadding="0" cellspacing="0" width="100%">
		  ...
		  ?>
		   ...
		   <td class="row_format"><?php echo $this->Form->checkbox('',array('name'=>$doctortemp['DischargeTemplate']['id'],'value'=>$doctortemp['DischargeTemplate']['description'])); ?></td>
		   <td class="row_format"><?php echo $doctortemp['DischargeTemplate']['template_type']; ?> </td>
		   <td class="row_format"><?php echo $doctortemp['DischargeTemplate']['description']; ?> </td>
		   <td>
		   <?php
...
<script>
			jQuery(document).ready(function(){
				...
				// binds form submission and fields to the validation engine
					...
					jQuery("#DischargeTemplatefrm").submit(function(){
						var returnVal = jQuery("#DischargeTemplatefrm").validationEngine('validate');						 
						if(returnVal){					 
					 		ajaxPost('DischargeTemplatefrm','doctemp_content');
					 	}
					});
				...
				function ajaxPost(formname,updateId){ 
				        ...
				        $.ajax({
				            ...
				            type:"post", 
				            url:"<?php echo $this->Html->url((array('action' => 'discharge_template')));?>"
				        }); 
				}
			});	
</script>
