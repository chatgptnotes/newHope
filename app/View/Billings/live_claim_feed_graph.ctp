...
<div id="multiaxischartdiv1" align="center" style="padding-top:50px;">
	<?php echo $this->JsFusionChart->showFusionChart("fusionx_charts/MSColumn2D.swf", "multiaxisChartId1", "80%", "400", "0", "0", "xmlString", "multiaxischartdiv1"); ?>
</div>