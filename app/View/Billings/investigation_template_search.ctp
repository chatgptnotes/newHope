							  ...
							  ?>
								   ...
								   <td class="row_format leftPad10" style="font-size:11px;">
								   		<?php 
								   		 	...
								   		 	echo $this->Js->link($doctortemp['DischargeTemplate']['template_name'] , array('action' => 'investigation_add_template_text', $doctortemp['DischargeTemplate']['id']), array('escape' => false,'update'=>"#$updateID",'method'=>'post','complete' => $this->Js->get('#busy-indicator-investigation')->effect('fadeOut', array('buffer' => false)),
								   ...
								   if($doctortemp['DischargeTemplate']['user_id']=='0'){
								   	echo "&nbsp;";
								   			...
								   			echo $this->Js->link($this->Html->image('icons/edit-icon.png', array('title'=> __('Discharge Investigation Template Edit', true), 'alt'=> __('Discharge Investigation', true))),
								   								 array('action' => 'investigation_template_add',$template_type, $doctortemp['DischargeTemplate']['id']), array('escape' => false,'update'=>"#$updateID",'method'=>'post','complete' => $this->Js->get('#busy-indicator-investigation')->effect('fadeOut', array('buffer' => false)),
								    							'before' => $this->Js->get('#busy-indicator-investigation')->effect('fadeIn', array('buffer' => false))));
