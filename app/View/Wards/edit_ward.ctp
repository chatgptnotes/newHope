<!-- Right Part Template -->
<?php 
	echo $this->Form->create('Ward',array('controller'=>'wards','action'=>'editWard','id'=>'ward','inputDefaults' => array(
																								        'label' => false,
																								        'div' => false,
																								        'error' => false,
																								        'legend'=>false,
	...
	echo $this->Form->hidden('Ward.id',array());			
?>
<div class="inner_title">
<h3 style="float:left;">Edit Ward</h3>
	...
	<tr>
		...
		<table width="350" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td align="left" valign="middle"><?php  
					echo $this->Form->input('name',array('class' => 'validate[required,custom[Wardname]]','type'=>'text','legend'=>false,'label'=>false,'id' => 'name_1')); ?></td>
			
			</tr>
			<tr>
				<td height="35" valign="middle" class="tdLabel1" id="boxSpace2">Ward ID :<font color="red">*</font>
				
				</td>
				<td align="left" valign="middle"><?php   echo  $this->data['Ward']['wardid'];
				/* $this->Form->input('wardid',array('type'=>'text','class' => 'validate[required,custom[Wardid]]','legend'=>false,'label'=>false,'id' => 'ward_id_1')); */ ?>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" id="wardSubService">
					<tr>
						...
						<td width="50%" align="left" valign="middle"><?php
							echo $this->Form->input('no_of_rooms',array('class' => 'validate[required,custom[no_of_rooms]] textBoxExpnd','type'=>'text','id' => 'no_of_rooms_1'));
						?></td> 
					</tr>
					<tr>
					...
					<tr>
						...
						<td  align="left" valign="middle">
							<?php 
									echo $this->Form->input('Ward.tariff_list_id', array('options'=>$tariffList,'label'=>false, 
...
<div class="btns">
 <!--<input name="addMore" id="addMore" type="button"	value="Add More" class="blueBtn" tabindex="8" />
...
jQuery(document).ready(function(){
	...
	var corporateSubServicecounter = 2;
	...
	$("#addMore").click(function () {	//alert('here'); 
		...
		var addTRHtml = '<td valign="middle" height="35" id="boxSpace1" class="tdLabel1">Sub-service/Cost:<font color="red">*</font></td><td valign="middle" align="left"><div class="input text"><input  "class= validate[required,custom[mandatory-enter-only]]",type="text" id="sub_service_1" name="data[Ward][sub_service][]"></div></td><td>&nbsp;</td><td>&nbsp;</td><td><div class="input text"><font color="red">*</font><input  "class= validate[required,custom[mandatory-enter-only]]", type="text" id="sub_service_cost_1" style="width: 80px;" name="data[Ward][sub_service_cost][]"></div></td>';
