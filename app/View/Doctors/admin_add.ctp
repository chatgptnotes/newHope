...
<?php } ?>
<form name="doctorfrm" id="doctorfrm" action="<?php echo $this->Html->url(array("controller" => "doctors", "action" => "add", "admin" => true)); ?>" method="post" onSubmit="return Validate(this);" >
