...
<?php } ?>
<form name="doctorfrm" id="doctorfrm" action="<?php echo $this->Html->url(array("controller" => "doctors", "action" => "edit", "superadmin" => true)); ?>" method="post" onSubmit="return Validate(this);" >
        <?php 
	...
	<td>
        <?php echo $this->request->data['Doctor']['email']; ?>
       	</td>
	</tr>
        <tr>
	<td class="form_lables">
