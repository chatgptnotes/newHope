<div class="inner_title">
 <h3><?php echo __('Add Credit Type', true); ?></h3>
</div>
<script>
...
<?php } ?>
<form name="credittypefrm" id="credittypefrm" action="<?php echo $this->Html->url(array("action" => "add")); ?>" method="post" onSubmit="return Validate(this);" >
