<div class="inner_title">
 <h3><?php echo __('Edit Corporate', true); ?></h3>
</div>
<script>
...
<?php } ?>
<form name="corporatefrm" id="corporatefrm" action="<?php echo $this->Html->url(array("action" => "edit")); ?>" method="post" onSubmit="return Validate(this);">
        <?php
              echo $this->Form->input('Corporate.id', array('type' => 'hidden')); 
              echo $this->Form->input('Corporate.credit_type_id', array('type' => 'hidden', 'value' => 1));
         ?>
	...
	<td>
	  ...
	  <td>
	   <?php 
	          echo $this->Form->input('Corporate.name', array('class' => 'validate[required,custom[customname]]','id' => 'customname', 'label'=> false, 'div' => false, 'error' => false));
	   ?>
	  </td>
	 </tr>
 	 <tr>
