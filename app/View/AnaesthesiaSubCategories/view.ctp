...
<table border="0" cellpadding="0" cellspacing="0" align="center" class="table_view_format">
 <tr class="first">
  ...
  <td>
   <?php echo $anesthesia_subcategory['AnesthesiaCategory']['name']; ?>
  </td>
 </tr>
 <tr>
  <td class="row_format"><strong>
  ...
  <td>
   <?php echo $anesthesia_subcategory['AnesthesiaSubcategory']['name']; ?>
  </td>
 </tr>
<tr class="row_gray">
  <td class="row_format"><strong>
  ...
  <td>
   <?php echo $anesthesia_subcategory['AnesthesiaSubcategory']['description']; ?>
  </td>
 </tr>
 </table>
