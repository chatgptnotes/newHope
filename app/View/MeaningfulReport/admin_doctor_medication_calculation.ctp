<div class="inner_title">
	<h3>	
			<div style="float:left"><?php echo __('Measure Calculation Details'); ?></div>			
...
<table border="0" class="table_format" cellpadding="0" cellspacing="0" width="100%">
  ...
  ?>
   ...
   <td class="row_format"><?php echo $doctorPatientListVal['Patient']['email']; ?> </td>
   <td class="row_format"><?php echo $doctorPatientListVal['Patient']['mobile_phone']; ?> </td>
   </tr>
  <?php endforeach;  ?>
