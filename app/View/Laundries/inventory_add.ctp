...
<h3>&nbsp; <?php echo __('Allot Items to Room', true); ?></h3>
</div>
<?php 
  if(!empty($errors)) {
?>
...
<form name="itemfrm" id="itemfrm" action="<?php echo $this->Html->url(array("controller" => $this->params['controller'], "action" => "inventory_add/", )); ?>" method="post" >
	...
	<tr>
		...
		<td width="250"><?php 
        echo $this->Form->input('InventoryLaundry.date', array('label'=> false, 'div' => false, 'error' => false,'type'=>'text','readonly'=>'readonly','value'=>date('d/m/Y h:i A')));?></td>
	  ...
	  <tr>
		...
		<td width="250"><?php 
        echo $this->Form->input('InventoryLaundry.name', array('options'=>$items,'empty'=>__('Please select'),'class' => 'validate[required,custom[name]]', 'id' => 'item_name', 'label'=> false, 'div' => false, 'error' => false,'onchange'=> $this->Js->request(array('action' => 'add','inventory'=>true),array('before' => $this->Js->get('#busy-indicator')->effect('fadeIn', array('buffer' => false)),'complete' => $this->Js->get('#busy-indicator')->effect('fadeOut', array('buffer' => false)), 'async' => true, 'update' => '#changeCreditTypeList', 'data' => '{item_id:$("#item_name").val()}', 'dataExpression' => true, 'div'=>false))));?></td>
	  ...
	  <tr>
		...
		<td><?php 
        echo $this->Form->input('InventoryLaundry.quantity', array('type'=>'text','class' => 'validate[required,custom[quantity]]', 'id' => 'total_quantity', 'label'=> false, 'div' => false, 'error' => false,'onchange'=>'getTotalQuantity();'));?>
		</td>
	...
	<!-- <tr>
	  <td class="tdLabel" id="boxSpace">Minimum <font color="red">*</font></td>
		<td><?php 
        echo $this->Form->input('InventoryLaundry.minimum_quantity', array('label'=> false, 'div' => false, 'error' => false)  );?></td>
	   
	   <td class="tdLabel" id="boxSpace"> Maximum</td>
	   <td><?php 
        echo $this->Form->input('InventoryLaundry.maximum_quantity', array('label'=> false, 'div' => false, 'error' => false)  );?></td>
	 </tr>
	 <tr>
	   <td valign="middle" class="tdLabel" id="boxSpace">Generic</td>
		<td><?php 
        echo $this->Form->input('InventoryLaundry.generic', array('label'=> false, 'div' => false, 'error' => false)  );?></td>
	   
	   <td class="tdLabel" id="boxSpace"> Expiry Date</td>
	   <td><?php 
        echo $this->Form->input('InventoryLaundry.expiry_date', array('id'=>'expiryDate','label'=> false, 'div' => false, 'error' => false,'type'=>'text','readonly'=>'readonly'));?></td>
	 </tr>-->
	</table>
